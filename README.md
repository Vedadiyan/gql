...
# Compilation 
GQL relies on  [sqlparser](https://github.com/xwb1989/sqlparser) which itself relies on [vitess](https://github.com/vitessio/vitess). For that reason, compilation of `SQL` (MySQL syntax) is done reliably and efficiently as vitess is a reliable database clustering system for horizontal scaling of MySQL through generalized sharding.
